...
//   }
  ...
  //   const String accessToken = 'EAAI0pKUvkRMBOZBX6EZCZCPDRRgLk0tcYaPbEEqDVKCnyZBy7G4bmQirtMdXJ9BNtXPlacDsr60Bd1k5vQKNZBeger2jLgkMvgKVsZBNlNZCJ7OVefqSLGvdwXFDVThv6zNsEJeo8g2USfhxrYDVgR4frtM08ghyvLMZCS0ZAZC5CYX4rTo0gdsZBVJhPaAtC0PDBUISdfAi3PatSkHMH75DNSvE4O6VF18nAZDZD';
...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  String _generateOTP() {
    ...
    const String apiUrl =
        'https://graph.facebook.com/v22.0/555403124326299/messages';
    const String accessToken = 'EAAI0pKUvkRMBO7SVIPFVxMeEOCfKWDyEZBhMISnkGZAGJceluQZBSQDD83RuKT3GbTJE0aWmuf57kXd3wt9fHpTHOfUNnr9D3IBObFhbDOnL4NHCIv6RtvoeDIZCGKTaVR5Q4YtBnZANZBq6I7CnzLNQl7nW69pwnVOLwOwrgmRWaaN7vvgUjZC2aJffZBjI85PYraUbt77LJnZAZCBMRw3QwzoWYtEssZD';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                EnterOTPPage(otp: _generatedOTP!, phoneNumber: phoneNumber),
          ),
        );
      } else {
        print('Failed to send message: ${response.body}');
...
class EnterOTPPage extends StatefulWidget {
  ...
  const EnterOTPPage({super.key, required this.otp, required this.phoneNumber});
